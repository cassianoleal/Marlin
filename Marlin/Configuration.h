...
#define STRING_CONFIG_H_AUTHOR "cassianoleal" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10 Mini EZABL"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "e95495b2-58aa-4e28-8d5c-2c07f81d2a69"
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.385 // Z offset: -below +above  [the nozzle]
